...
const EmptyState = ({ title, buttonLink, buttonText, search }: EmptyStateProps) => {
    return (
        <section className='flex flex-center flex-col gap-3'>
            <Image src='/icons/emptyState.svg' width={250} height={250} alt='empty state'></Image>
            <div className='flex-center w-full max-w-[254px] flex-col gap-3'>
                ...
                {buttonLink && (
                    <Button className='bg-orange-1 '>
                        ...
                        <Image src='/icons/discover.svg' width={20}height={20} alt='discover'></Image>
